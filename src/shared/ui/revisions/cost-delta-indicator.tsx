 ...
 * CostDeltaIndicator
 *
 * Displays the cost/value change between the active and draft revisions.
 * Shows both absolute and percentage changes with appropriate styling.
 */

import { TrendingUp, TrendingDown, Minus } from "lucide-react"
import { cn } from "@/lib/utils"
import type { CostDeltaInfo, RevisionTerminology } from "./types"
...
export function CostDeltaIndicator({
  costDeltaInfo,
