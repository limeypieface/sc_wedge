                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-3 px-4">
                      <div>
                        <div className="flex items-center gap-2">
                          <p className="text-sm font-medium">{item.needs[0]?.moNumber}</p>
                          {item.needs.length > 1 && (
                    ...
                    <td className="py-3 px-4 text-center tabular-nums">
                      <div className="flex flex-col items-center">
                        <span>{item.needs[0]?.qtyNeeded}</span>
                        {item.needs.length > 1 && (
                    ...
                    <td className="py-3 px-4 text-center tabular-nums">{item.quantityAccepted}</td>
                    <td className="py-3 px-4 text-center">
                      {needStatus.status === "ok" && needStatus.needs.length === 0 ? (
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {lines.map((item) => {
                ...
                const qr = (item as { qualityRequirements?: { inspectionRequired?: boolean; cocRequired?: boolean; faiRequired?: boolean; mtrRequired?: boolean; sourceInspection?: boolean } }).qualityRequirements || { inspectionRequired: false, cocRequired: false, faiRequired: false, mtrRequired: false, sourceInspection: false }
