...
/**
 * PurchaseOrdersList - Displays a table of purchase orders
 *
 * This is a shared UI component extracted from the purchase orders page
              ...
              <tr key={order.id} className="border-b hover:bg-muted/30">
                ...
                <td className="py-3 px-3">
                  <div className="flex items-center gap-2">
                    <div className={`w-6 h-6 rounded-full ${getAvatarColor(order.supplier, supplierColors)} flex items-center justify-center text-white text-xs font-medium`}>
                ...
                <td className="py-3 px-3 text-muted-foreground">
                  {formatFutureDate(order.fulfillmentDate)}
                </td>
                <td className="py-3 px-3 text-muted-foreground">
