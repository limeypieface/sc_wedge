        ...
        <View style={styles.documentHeader}>
          ...
          <View style={styles.headerRow}>
            ...
            <View style={styles.headerRight}>
              ...
              <Text>Date Issued: {poHeader.dates.created}</Text>
          ...
          <View style={styles.twoColumn}>
            <View style={styles.column}>
              ...
              <View style={styles.fieldRow}>
                ...
                <Text style={styles.fieldValue}>{poHeader.shipping.instructions || "—"}</Text>
              </View>
              <View style={styles.fieldRow}>
            ...
            <View style={styles.column}>
              <View style={styles.fieldRow}>
                ...
                <Text style={styles.fieldValue}>{poHeader.currency}</Text>
              </View>
              <View style={styles.fieldRow}>
                <Text style={styles.fieldLabel}>Buyer Contact:</Text>
                <Text style={styles.fieldValue}>{poHeader.buyer}</Text>
              </View>
              <View style={styles.fieldRow}>
                <Text style={styles.fieldLabel}>Expected Completion:</Text>
                <Text style={styles.fieldValue}>{poHeader.dates.promised}</Text>
              </View>
            </View>
          </View>
        </View>
            ...
            {lineItems.map((line, index) => {
              ...
              return (
                <View key={line.id} style={isLast ? [styles.tableRow, styles.tableRowLast] : styles.tableRow}>
                  ...
                  <Text style={[styles.tableCell, styles.colDelivery]}>{line.needs?.[0]?.dateNeeded || line.promisedDate}</Text>
          ...
          <View style={styles.totalsTable}>
            ...
            {headerCharges.map((charge) => (
              <View key={charge.id} style={styles.totalsRow}>
                <Text style={styles.totalsLabel}>{charge.description}:</Text>
              ...
              <View key={line.id} style={styles.lineDetailBlock}>
                ...
                <View style={styles.lineDetailGrid}>
                  ...
                  <View style={styles.lineDetailItem}>
                    ...
                    <Text style={styles.lineDetailValue}>{line.needs?.[0]?.dateNeeded || line.promisedDate}</Text>
                  </View>
                  ...
                  <View style={styles.lineDetailItem}>
                    <Text style={styles.lineDetailLabel}>Tax ({line.taxCode || "STANDARD"})</Text>
      ...
      <Page size="LETTER" style={styles.page}>
        ...
        <View style={[styles.notesBlock, { marginTop: 30 }]}>
          ...
          <Text style={styles.notesText}>
            ...
            2. Email signed acknowledgment to: {companyInfo.email}{"\n"}
