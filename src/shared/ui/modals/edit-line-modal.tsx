...
interface EditLineModalProps {
  ...
  /** Display mode: "full" shows all fields, "mvp" shows simplified form */
  mode?: Mode
}
...
export function EditLineModal({ isOpen, onClose, onSave, line, lineCharges, mode = "full" }: EditLineModalProps) {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md max-h-[85vh] flex flex-col p-0 gap-0">
        ...
        <div className="flex-1 overflow-y-auto px-4 py-3 space-y-4">
          ...
          {/* Discount & Tax */}
          <div className={cn("grid gap-3", isMVP ? "grid-cols-1" : "grid-cols-2")}>
            {/* Discount - hidden in MVP mode */}
            {!isMVP && (
              <div>
