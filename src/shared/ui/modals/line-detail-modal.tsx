...
interface LineDetailModalProps {
  ...
  orderNumber: string
  variant?: Variant
  /** Display mode: "full" shows all details, "mvp" shows simplified view */
  mode?: Mode
}
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="pt-4">
          {/* Upcoming Shipments - hidden in MVP mode */}
          {!isMVP && upcomingEvents.length > 0 && (
          ...
          {activeTab === "overview" && (
            <div className="space-y-6">
              ...
              {/* Quantity Flow - hidden in MVP mode */}
              {!isMVP && (
                <div>
                  <h4 className="text-xs font-medium text-muted-foreground uppercase tracking-wide mb-3">
                    {config.flowTitle}
              ...
              {/* Quality Requirements - hidden in MVP mode */}
              {!isMVP && (
                <div>
              ...
              {/* Invoices & Payments - hidden in MVP mode */}
              {!isMVP && (
                <div>
                  <h4 className="text-xs font-medium text-muted-foreground uppercase tracking-wide mb-3">
          ...
          {/* Needs Tab (PO only) - Shows MOs and SOs that depend on this line - hidden in MVP mode */}
          {!isMVP && activeTab === "needs" && config.hasNeedsTab && (
          ...
          {/* Issues Tab - hidden in MVP mode */}
          {!isMVP && activeTab === "issues" && (
            <div className="space-y-4">
