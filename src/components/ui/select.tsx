...
function SelectTrigger({
  ...
  return (
    <div className={cn("relative w-fit rounded-lg", className)}>
      <SelectPrimitive.Trigger
        ...
        className={cn(
          ...
          glimmer && "border-[#705E00] dark:border-[#705E00] bg-[#FFE601]/26 dark:bg-[#FFE601]/26 hover:bg-[#FFE601]/26 dark:hover:bg-[#FFE601]/26",
          className
        )}
        {...props}
      >
