...
interface SOLineDisplaySelectorProps {
  value: string
  onChange: (value: string) => void
}

// SO-specific views (no Needs or Sourcing - those are PO concepts)
const SO_VIEW_OPTIONS = [
...
export function SOLineDisplaySelector({ value, onChange }: SOLineDisplaySelectorProps) {
