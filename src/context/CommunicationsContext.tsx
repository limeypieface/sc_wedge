...
const initialCommunications: Communication[] = [
  {
    ...
    timestamp: "10:15 AM",
    date: "Jan 5, 2026",
    from: { name: poHeader.buyer, email: `${poHeader.buyer.toLowerCase().replace(/\s/g, ".")}@company.com` },
  ...
  },
  {
    ...
    to: { name: poHeader.buyer, email: `${poHeader.buyer.toLowerCase().replace(/\\s/g, ".")}@company.com` },
    status: "read",
    threadId: "thread-po",
  },
  {
